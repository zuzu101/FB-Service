...
class ReportController extends Controller
{
    ...
    {
        return view('back.cms.Report.index');
    }
    ...
    public function daily(Request $request)
    {
        ...
        return view('back.cms.Report.daily', compact('date'));
    }
    ...
    public function weekly(Request $request)
    {
        ...
        return view('back.cms.Report.weekly', compact('week'));
    }
    ...
    public function monthly(Request $request)
    {
        ...
        return view('back.cms.Report.monthly', compact('month'));
    }
    ...
    {
        return view('back.cms.Report.issue');
    }
    ...
    {
        return view('back.cms.Report.history');
    }
